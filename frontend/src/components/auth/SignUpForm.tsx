...
export function SignUpForm() {
  ...
  return (
    /*
     * Override dark-theme CSS vars locally so shared Input/Button
     * components render correctly inside this light-theme auth page.
     */
    <div data-theme="auth" className="flex flex-col gap-5">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1">
          ...
          {errors.terms && (
            <p className="text-xs text-[#ef4444]">{errors.terms.message}</p>
          )}
        </div>
